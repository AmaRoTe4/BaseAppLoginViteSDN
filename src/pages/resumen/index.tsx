    ...
    return (
        <Layout>
            <nav className="w-full pt-3 pb-2 flex justify-center">
                <h1 className="text-[35px] font-bold dark:text-gray-100">Resumen</h1>
            </nav>
            <section className="px-5 pt-2 py-4 dark:text-gray-100">
                ...
                <div className="w-full flex gap-2">
                    ...
                    <p className="w-[10px]">$</p>
                    <input
                        className="w-[100px] m-0 p-0 dark:text-gray-100 dark:bg-gray-900"
                        placeholder="cambio"
                        type="number"
                        value={cambio}
                ...
                <div className="w-full flex gap-2 pt-1 border-t border-black dark:border-gray-100">
